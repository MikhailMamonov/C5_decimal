...
ADD_TEST_CASES(
    ...
    {.value1 = {{0x00000005, 0x00000000, 0x00000000, 0x80000000}},  // -5
     ...
     .expected_result = {{0x00000008, 0x00000000, 0x00000000,
                          0x80000000}},  // -8
     .expected_return_code = 0,
     .test_name = "-5 + (-3) = -8"})
...
ADD_TEST_CASES(
    ...
    {.value1 = {{0x0000000A, 0x00000000, 0x00000000, 0x00000000}},  // 10
     ...
     .expected_result = {{0x00000006, 0x00000000, 0x00000000,
                          0x00000000}},  // 6
     .expected_return_code = 0,
     .test_name = "10 + (-4) = 6"})
...
ADD_TEST_CASES(
    ...
    {.value1 = {{0x00000005, 0x00000000, 0x00000000, 0x00000000}},  // 5
     ...
     .expected_result = {{0x00000007, 0x00000000, 0x00000000,
                          0x80000000}},  // -7
     .expected_return_code = 0,
     .test_name = "5 + (-12) = -7"})

ADD_TEST_CASES(
    add_big_numbers_without_overflow_0_to_1,
    {.value1 = {{MAX_MASK, 0x00000000, 0x00000000, 0x00000000}},  // MAX_UINT32
     .value2 = {{0x00000001, 0x00000000, 0x00000000, 0x00000000}},  // 1
     .expected_result = {{0x00000000, 0x00000001, 0x00000000,
                          0x00000000}},  // 2^32
     .expected_return_code = 0,
     .test_name = "Carry from bits[0] to bits[1]"})

ADD_TEST_CASES(
    add_big_numbers_without_overflow_1_to_2,
    {.value1 = {{MAX_MASK, MAX_MASK, 0x00000000, 0x00000000}},      // 2^64 - 1
     .value2 = {{0x00000001, 0x00000000, 0x00000000, 0x00000000}},  // 1
     .expected_result = {{0x00000000, 0x00000000, 0x00000001,
                          0x00000000}},  // 2^64
     .expected_return_code = 0,
