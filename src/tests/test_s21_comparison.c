...
COMPARE_EQUAL_TEST_CASES(
    equal_negative_different_scales,
...
COMPARE_EQUAL_TEST_CASES(
    not_equal_negative_different_scales,
    {.value1 = {{0x0000000F, 0x00000000, 0x00000000, 0x80010000}},  // -1.5
...
COMPARE_EQUAL_TEST_CASES(
    equal_max_with_scale,
    {.value1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000}},  // MAX
     .value2 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
...
COMPARE_EQUAL_TEST_CASES(
    equal_very_small_diff_scale,
    {.value1 = {{0x00000001, 0x00000000, 0x00000000, 0x001C0000}},  // 1e-28
     .value2 = {{0x0000000A, 0x00000000, 0x00000000,
                 0x001D0000}},  // 1e-28 (scale 29)
     .expected_result = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}},
     .expected_return_code = 1,
...
COMPARE_NOT_EQUAL_TEST_CASES(
    not_equal_true_simple,
    {.value1 = {{0x00000005, 0x00000000, 0x00000000, 0x00000000}},  // 5
...
COMPARE_NOT_EQUAL_TEST_CASES(
    not_equal_true_zero_and_positive,
    {.value1 = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}},  // 0
     .value2 = {{0x00000005, 0x00000000, 0x00000000, 0x00000000}},  // 5
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_NOT_EQUAL_TEST_CASES(
    not_equal_true_zero_and_negative,
    {.value1 = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}},  // 0
     .value2 = {{0x00000005, 0x00000000, 0x00000000, 0x80000000}},  // -5
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_NOT_EQUAL_TEST_CASES(
    not_equal_true_different_scale_1,
    {.value1 = {{0x0000000F, 0x00000000, 0x00000000, 0x00010000}},  // 1.5
     .value2 = {{0x00000097, 0x00000000, 0x00000000, 0x00020000}},  // 1.51
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_NOT_EQUAL_TEST_CASES(
    not_equal_true_different_scale_2,
    {.value1 = {{0x00000001, 0x00000000, 0x00000000, 0x00000000}},  // 1
     .value2 = {{0x0000000B, 0x00000000, 0x00000000, 0x00010000}},  // 1.1
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_NOT_EQUAL_TEST_CASES(
    not_equal_true_negative_different_scales,
    {.value1 = {{0x0000000F, 0x00000000, 0x00000000, 0x80010000}},  // -1.5
     .value2 = {{0x00000097, 0x00000000, 0x00000000, 0x80020000}},  // -1.51
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_NOT_EQUAL_TEST_CASES(
    not_equal_false_zero_both_negative,
    {.value1 = {{0x00000000, 0x00000000, 0x00000000, 0x80000000}},  // -0
     .value2 = {{0x00000000, 0x00000000, 0x00000000, 0x80000000}},  // -0
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_NOT_EQUAL_TEST_CASES(
    not_equal_false_zero_different_scales,
    {.value1 = {{0x00000000, 0x00000000, 0x00000000, 0x00030000}},  // 0.000
     .value2 = {{0x00000000, 0x00000000, 0x00000000, 0x00050000}},  // 0.00000
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_NOT_EQUAL_TEST_CASES(
    not_equal_false_different_scale_1,
    {.value1 = {{0x0000000F, 0x00000000, 0x00000000, 0x00010000}},  // 1.5
     .value2 = {{0x00000096, 0x00000000, 0x00000000, 0x00020000}},  // 1.50
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_NOT_EQUAL_TEST_CASES(
    not_equal_false_different_scale_2,
    {.value1 = {{0x00000001, 0x00000000, 0x00000000, 0x00000000}},  // 1
     .value2 = {{0x0000000A, 0x00000000, 0x00000000, 0x00010000}},  // 1.0
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_NOT_EQUAL_TEST_CASES(
    not_equal_false_different_scale_3,
    {.value1 = {{0x00000064, 0x00000000, 0x00000000, 0x00020000}},  // 1.00
     .value2 = {{0x00000001, 0x00000000, 0x00000000, 0x00000000}},  // 1
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_NOT_EQUAL_TEST_CASES(
    not_equal_false_negative_different_scales,
    {.value1 = {{0x0000000F, 0x00000000, 0x00000000, 0x80010000}},  // -1.5
     .value2 = {{0x00000096, 0x00000000, 0x00000000, 0x80020000}},  // -1.50
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_NOT_EQUAL_TEST_CASES(
    not_equal_false_very_small_diff_scale,
    {.value1 = {{0x00000001, 0x00000000, 0x00000000, 0x001C0000}},  // 1e-28
     .value2 = {{0x0000000A, 0x00000000, 0x00000000,
                 0x001D0000}},  // 1e-28 (scale 29)
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
...
COMPARE_LESS_TEST_CASES(
    less_true_negative_different_scales,
    {.value1 = {{0x0000000F, 0x00000000, 0x00000000, 0x80010000}},  // -1.5
...
COMPARE_LESS_TEST_CASES(
    less_false_zero_different_scales,
    {.value1 = {{0x00000000, 0x00000000, 0x00000000, 0x00030000}},  // 0.000
     .value2 = {{0x00000000, 0x00000000, 0x00000000, 0x00050000}},  // 0.00000
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_LESS_TEST_CASES(
    less_false_negative_different_scales,
...
COMPARE_LESS_TEST_CASES(less_true_large_scale,
                        {.value1 = {{0x0001E240, 0x00000000, 0x00000000,
                                     0x00060000}},  // 0.123456
                         .value2 = {{0x00BC6100, 0x00000000, 0x00000000,
                                     0x00080000}},  // 0.12345600
...
COMPARE_LESS_OR_EQUAL_TEST_CASES(
    less_or_equal_true_simple_less,
    {.value1 = {{0x00000003, 0x00000000, 0x00000000, 0x00000000}},  // 3
     .value2 = {{0x00000005, 0x00000000, 0x00000000, 0x00000000}},  // 5
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_LESS_OR_EQUAL_TEST_CASES(
    less_or_equal_true_simple_equal,
    {.value1 = {{0x00000005, 0x00000000, 0x00000000, 0x00000000}},  // 5
     .value2 = {{0x00000005, 0x00000000, 0x00000000, 0x00000000}},  // 5
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_LESS_OR_EQUAL_TEST_CASES(
    less_or_equal_true_negative_less,
    {.value1 = {{0x00000005, 0x00000000, 0x00000000, 0x80000000}},  // -5
     .value2 = {{0x00000003, 0x00000000, 0x00000000, 0x80000000}},  // -3
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_LESS_OR_EQUAL_TEST_CASES(
    less_or_equal_true_negative_equal,
    {.value1 = {{0x00000005, 0x00000000, 0x00000000, 0x80000000}},  // -5
     .value2 = {{0x00000005, 0x00000000, 0x00000000, 0x80000000}},  // -5
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_LESS_OR_EQUAL_TEST_CASES(
    less_or_equal_true_mixed_sign_1,
    {.value1 = {{0x00000005, 0x00000000, 0x00000000, 0x80000000}},  // -5
     .value2 = {{0x00000003, 0x00000000, 0x00000000, 0x00000000}},  // 3
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_LESS_OR_EQUAL_TEST_CASES(
    less_or_equal_true_mixed_sign_2,
    {.value1 = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}},  // 0
     .value2 = {{0x00000005, 0x00000000, 0x00000000, 0x00000000}},  // 5
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_LESS_OR_EQUAL_TEST_CASES(
    less_or_equal_true_mixed_sign_3,
    {.value1 = {{0x00000005, 0x00000000, 0x00000000, 0x80000000}},  // -5
     .value2 = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}},  // 0
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_LESS_OR_EQUAL_TEST_CASES(
    less_or_equal_true_zero_positive,
    {.value1 = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}},  // +0
     .value2 = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}},  // +0
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_LESS_OR_EQUAL_TEST_CASES(
    less_or_equal_true_zero_negative,
    {.value1 = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}},  // +0
     .value2 = {{0x00000000, 0x00000000, 0x00000000, 0x80000000}},  // -0
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_LESS_OR_EQUAL_TEST_CASES(
    less_or_equal_true_zero_both_negative,
    {.value1 = {{0x00000000, 0x00000000, 0x00000000, 0x80000000}},  // -0
     .value2 = {{0x00000000, 0x00000000, 0x00000000, 0x80000000}},  // -0
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_LESS_OR_EQUAL_TEST_CASES(
    less_or_equal_true_zero_different_scales,
    {.value1 = {{0x00000000, 0x00000000, 0x00000000, 0x00030000}},  // 0.000
     .value2 = {{0x00000000, 0x00000000, 0x00000000, 0x00050000}},  // 0.00000
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_LESS_OR_EQUAL_TEST_CASES(
    less_or_equal_true_different_scale_less,
    {.value1 = {{0x0000000F, 0x00000000, 0x00000000, 0x00010000}},  // 1.5
     .value2 = {{0x000000FA, 0x00000000, 0x00000000, 0x00020000}},  // 2.50
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_LESS_OR_EQUAL_TEST_CASES(
    less_or_equal_true_different_scale_equal,
    {.value1 = {{0x0000000F, 0x00000000, 0x00000000, 0x00010000}},  // 1.5
     .value2 = {{0x00000096, 0x00000000, 0x00000000, 0x00020000}},  // 1.50
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_LESS_OR_EQUAL_TEST_CASES(
    less_or_equal_true_negative_different_scales_less,
    {.value1 = {{0x0000000F, 0x00000000, 0x00000000, 0x80010000}},  // -1.5
     .value2 = {{0x00000064, 0x00000000, 0x00000000, 0x80020000}},  // -1.00
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_LESS_OR_EQUAL_TEST_CASES(
    less_or_equal_true_negative_different_scales_equal,
    {.value1 = {{0x0000000F, 0x00000000, 0x00000000, 0x80010000}},  // -1.5
     .value2 = {{0x00000096, 0x00000000, 0x00000000, 0x80020000}},  // -1.50
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_LESS_OR_EQUAL_TEST_CASES(
    less_or_equal_true_decimal_less,
    {.value1 = {{0x00000001, 0x00000000, 0x00000000, 0x00010000}},  // 0.1
     .value2 = {{0x0000000B, 0x00000000, 0x00000000, 0x00020000}},  // 0.11
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_LESS_OR_EQUAL_TEST_CASES(
    less_or_equal_true_decimal_equal,
    {.value1 = {{0x00000001, 0x00000000, 0x00000000, 0x00010000}},  // 0.1
     .value2 = {{0x0000000A, 0x00000000, 0x00000000, 0x00020000}},  // 0.10
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_LESS_OR_EQUAL_TEST_CASES(
    less_or_equal_true_large_scale_equal,
    {.value1 = {{0x0001E240, 0x00000000, 0x00000000, 0x00060000}},  // 0.123456
     .value2 = {{0x075BCD15, 0x00000000, 0x00000000,
                 0x00090000}},  // 0.123456000
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
     .expected_return_code = 1,
     .test_name = "0.123456 <= 0.123456000 is TRUE"})
...
COMPARE_LESS_OR_EQUAL_TEST_CASES(
    less_or_equal_false_mixed_sign_1,
    {.value1 = {{0x00000003, 0x00000000, 0x00000000, 0x00000000}},  // 3
     .value2 = {{0x00000005, 0x00000000, 0x00000000, 0x80000000}},  // -5
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_LESS_OR_EQUAL_TEST_CASES(
    less_or_equal_false_mixed_sign_2,
    {.value1 = {{0x00000005, 0x00000000, 0x00000000, 0x00000000}},  // 5
     .value2 = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}},  // 0
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_LESS_OR_EQUAL_TEST_CASES(
    less_or_equal_false_different_scale_1,
...
COMPARE_LESS_OR_EQUAL_TEST_CASES(
    less_or_equal_false_different_scale_2,
    {.value1 = {{0x00000001, 0x00000000, 0x00000000, 0x00000000}},  // 1
     .value2 = {{0x0000000A, 0x00000000, 0x00000000, 0x00010000}},  // 1.0
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_LESS_OR_EQUAL_TEST_CASES(
    less_or_equal_false_negative_different_scales,
    {.value1 = {{0x00000064, 0x00000000, 0x00000000, 0x80020000}},  // -1.00
     .value2 = {{0x0000000F, 0x00000000, 0x00000000, 0x80010000}},  // -1.5
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_LESS_OR_EQUAL_TEST_CASES(
    less_or_equal_false_max_with_scale,
    {.value1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000}},  // MAX
     .value2 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
                 0x00010000}},  // MAX (scale 1)
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
...
COMPARE_LESS_OR_EQUAL_TEST_CASES(
    less_or_equal_false_no_overflow,
    {.value1 = {{0xFFFFFFFF, 0x00000000, 0x00000000, 0x00020000}},  // MAX/100
     .value2 = {{0x19999999, 0x00000000, 0x00000000, 0x00010000}},  // MAX/10
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_GREATER_TEST_CASES(
    greater_true_different_scale_1,
    {.value1 = {{0x000000FA, 0x00000000, 0x00000000, 0x00020000}},  // 2.50
     .value2 = {{0x0000000F, 0x00000000, 0x00000000, 0x00010000}},  // 1.5
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_GREATER_TEST_CASES(
    greater_true_negative_different_scales,
    {.value1 = {{0x00000064, 0x00000000, 0x00000000, 0x80020000}},  // -1.00
     .value2 = {{0x0000000F, 0x00000000, 0x00000000, 0x80010000}},  // -1.5
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_GREATER_TEST_CASES(
    greater_false_zero_both_negative,
    {.value1 = {{0x00000000, 0x00000000, 0x00000000, 0x80000000}},  // -0
     .value2 = {{0x00000000, 0x00000000, 0x00000000, 0x80000000}},  // -0
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_GREATER_TEST_CASES(
    greater_false_zero_different_scales,
    {.value1 = {{0x00000000, 0x00000000, 0x00000000, 0x00030000}},  // 0.000
     .value2 = {{0x00000000, 0x00000000, 0x00000000, 0x00050000}},  // 0.00000
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_GREATER_TEST_CASES(
    greater_false_different_scale_1,
    {.value1 = {{0x0000000F, 0x00000000, 0x00000000, 0x00010000}},  // 1.5
     .value2 = {{0x000000FA, 0x00000000, 0x00000000, 0x00020000}},  // 2.50
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_GREATER_TEST_CASES(
    greater_false_different_scale_2,
    {.value1 = {{0x00000096, 0x00000000, 0x00000000, 0x00020000}},  // 1.50
     .value2 = {{0x0000000F, 0x00000000, 0x00000000, 0x00010000}},  // 1.5
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_GREATER_TEST_CASES(
    greater_false_negative_different_scales,
    {.value1 = {{0x0000000F, 0x00000000, 0x00000000, 0x80010000}},  // -1.5
     .value2 = {{0x00000064, 0x00000000, 0x00000000, 0x80020000}},  // -1.00
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_GREATER_TEST_CASES(
    greater_true_different_scale_2,
    {.value1 = {{0x00000001, 0x00000000, 0x00000000, 0x00000000}},  // 1
     .value2 = {{0x0000000A, 0x00000000, 0x00000000, 0x00010000}},  // 1.0
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_GREATER_TEST_CASES(
    greater_true_large_scale,
    {.value1 = {{0x00BC6100, 0x00000000, 0x00000000,
                 0x00080000}},  // 0.12345600
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_true_simple_greater,
    {.value1 = {{0x00000005, 0x00000000, 0x00000000, 0x00000000}},  // 5
     .value2 = {{0x00000003, 0x00000000, 0x00000000, 0x00000000}},  // 3
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_true_simple_equal,
    {.value1 = {{0x00000005, 0x00000000, 0x00000000, 0x00000000}},  // 5
     .value2 = {{0x00000005, 0x00000000, 0x00000000, 0x00000000}},  // 5
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_true_negative_greater,
    {.value1 = {{0x00000003, 0x00000000, 0x00000000, 0x80000000}},  // -3
     .value2 = {{0x00000005, 0x00000000, 0x00000000, 0x80000000}},  // -5
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_true_negative_equal,
    {.value1 = {{0x00000005, 0x00000000, 0x00000000, 0x80000000}},  // -5
     .value2 = {{0x00000005, 0x00000000, 0x00000000, 0x80000000}},  // -5
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_true_mixed_sign_1,
    {.value1 = {{0x00000003, 0x00000000, 0x00000000, 0x00000000}},  // 3
     .value2 = {{0x00000005, 0x00000000, 0x00000000, 0x80000000}},  // -5
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_true_mixed_sign_2,
    {.value1 = {{0x00000005, 0x00000000, 0x00000000, 0x00000000}},  // 5
     .value2 = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}},  // 0
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_true_mixed_sign_3,
    {.value1 = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}},  // 0
     .value2 = {{0x00000005, 0x00000000, 0x00000000, 0x80000000}},  // -5
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_true_zero_positive,
    {.value1 = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}},  // +0
     .value2 = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}},  // +0
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_true_zero_negative,
    {.value1 = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}},  // +0
     .value2 = {{0x00000000, 0x00000000, 0x00000000, 0x80000000}},  // -0
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_true_zero_both_negative,
    {.value1 = {{0x00000000, 0x00000000, 0x00000000, 0x80000000}},  // -0
     .value2 = {{0x00000000, 0x00000000, 0x00000000, 0x80000000}},  // -0
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_true_zero_different_scales,
    {.value1 = {{0x00000000, 0x00000000, 0x00000000, 0x00030000}},  // 0.000
     .value2 = {{0x00000000, 0x00000000, 0x00000000, 0x00050000}},  // 0.00000
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_true_different_scale_greater,
    {.value1 = {{0x000000FA, 0x00000000, 0x00000000, 0x00020000}},  // 2.50
     .value2 = {{0x0000000F, 0x00000000, 0x00000000, 0x00010000}},  // 1.5
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_true_different_scale_equal,
    {.value1 = {{0x00000096, 0x00000000, 0x00000000, 0x00020000}},  // 1.50
     .value2 = {{0x0000000F, 0x00000000, 0x00000000, 0x00010000}},  // 1.5
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_true_negative_different_scales_greater,
    {.value1 = {{0x00000064, 0x00000000, 0x00000000, 0x80020000}},  // -1.00
     .value2 = {{0x0000000F, 0x00000000, 0x00000000, 0x80010000}},  // -1.5
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_true_negative_different_scales_equal,
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_true_decimal_greater,
    {.value1 = {{0x0000000B, 0x00000000, 0x00000000, 0x00020000}},  // 0.11
     .value2 = {{0x00000001, 0x00000000, 0x00000000, 0x00010000}},  // 0.1
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_true_decimal_equal,
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_true_near_max,
    {.value1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000}},  // MAX
     .value2 = {{0xFFFFFFFE, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000}},  // MAX - 1
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_true_max_equal,
    {.value1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000}},  // MAX
     .value2 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000}},  // MAX
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_true_max_with_scale,
    {.value1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000}},  // MAX
     .value2 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
                 0x00010000}},  // MAX (scale 1)
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_true_very_small,
    {.value1 = {{0x00000001, 0x00000000, 0x00000000, 0x001C0000}},  // 1e-28
     .value2 = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}},  // 0
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_true_large_scale_equal,
    {.value1 = {{0x075BCD15, 0x00000000, 0x00000000,
                 0x00090000}},  // 0.123456000
     .value2 = {{0x0001E240, 0x00000000, 0x00000000, 0x00060000}},  // 0.123456
     .expected_result = {{0x00000001, 0x00000000, 0x00000000,
                          0x00000000}},  // 1
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_true_no_overflow,
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_false_negative,
    {.value1 = {{0x00000005, 0x00000000, 0x00000000, 0x80000000}},  // -5
     .value2 = {{0x00000003, 0x00000000, 0x00000000, 0x80000000}},  // -3
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_false_mixed_sign_1,
    {.value1 = {{0x00000005, 0x00000000, 0x00000000, 0x80000000}},  // -5
     .value2 = {{0x00000003, 0x00000000, 0x00000000, 0x00000000}},  // 3
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_false_mixed_sign_2,
    {.value1 = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}},  // 0
     .value2 = {{0x00000005, 0x00000000, 0x00000000, 0x00000000}},  // 5
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_false_different_scale_1,
    {.value1 = {{0x0000000F, 0x00000000, 0x00000000, 0x00010000}},  // 1.5
     .value2 = {{0x000000FA, 0x00000000, 0x00000000, 0x00020000}},  // 2.50
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_false_different_scale_2,
    {.value1 = {{0x0000000A, 0x00000000, 0x00000000, 0x00010000}},  // 1.0
     .value2 = {{0x00000001, 0x00000000, 0x00000000, 0x00000000}},  // 1
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_false_negative_different_scales,
    {.value1 = {{0x0000000F, 0x00000000, 0x00000000, 0x80010000}},  // -1.5
     .value2 = {{0x00000064, 0x00000000, 0x00000000, 0x80020000}},  // -1.00
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_false_decimal,
    {.value1 = {{0x00000001, 0x00000000, 0x00000000, 0x00010000}},  // 0.1
     .value2 = {{0x0000000B, 0x00000000, 0x00000000, 0x00020000}},  // 0.11
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_false_near_max,
    {.value1 = {{0xFFFFFFFE, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000}},  // MAX - 1
     .value2 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000}},  // MAX
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
COMPARE_GREATER_OR_EQUAL_TEST_CASES(
    greater_or_equal_false_very_small,
    {.value1 = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}},  // 0
     .value2 = {{0x00000001, 0x00000000, 0x00000000, 0x001C0000}},  // 1e-28
     .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                          0x00000000}},  // 0
...
Suite *comparison_suite_create(void) {
  ...
  tcase_add_test(tc_less_or_equal,
                 test_less_or_equal_true_zero_different_scales);
  tcase_add_test(tc_less_or_equal,
                 test_less_or_equal_true_different_scale_less);
  tcase_add_test(tc_less_or_equal,
                 test_less_or_equal_true_different_scale_equal);
  tcase_add_test(tc_less_or_equal,
                 test_less_or_equal_true_negative_different_scales_less);
  tcase_add_test(tc_less_or_equal,
                 test_less_or_equal_true_negative_different_scales_equal);
  ...
  tcase_add_test(tc_less_or_equal,
                 test_less_or_equal_false_negative_different_scales);
  ...
  tcase_add_test(tc_greater_or_equal,
                 test_greater_or_equal_true_simple_greater);
  tcase_add_test(tc_greater_or_equal, test_greater_or_equal_true_simple_equal);
  tcase_add_test(tc_greater_or_equal,
                 test_greater_or_equal_true_negative_greater);
  tcase_add_test(tc_greater_or_equal,
                 test_greater_or_equal_true_negative_equal);
  ...
  tcase_add_test(tc_greater_or_equal,
                 test_greater_or_equal_true_zero_both_negative);
  tcase_add_test(tc_greater_or_equal,
                 test_greater_or_equal_true_zero_different_scales);
  tcase_add_test(tc_greater_or_equal,
                 test_greater_or_equal_true_different_scale_greater);
  tcase_add_test(tc_greater_or_equal,
                 test_greater_or_equal_true_different_scale_equal);
  tcase_add_test(tc_greater_or_equal,
                 test_greater_or_equal_true_negative_different_scales_greater);
  tcase_add_test(tc_greater_or_equal,
                 test_greater_or_equal_true_negative_different_scales_equal);
  tcase_add_test(tc_greater_or_equal,
                 test_greater_or_equal_true_decimal_greater);
  ...
  tcase_add_test(tc_greater_or_equal,
                 test_greater_or_equal_false_different_scale_1);
  tcase_add_test(tc_greater_or_equal,
                 test_greater_or_equal_false_negative_different_scales);
