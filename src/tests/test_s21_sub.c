...
SUB_TEST_CASES(
    ...
    {.value1 = {{0x0000000F, 0x00000000, 0x00000000, 0x80000000}},  // -15
     ...
     .expected_result = {{0x0000000A, 0x00000000, 0x00000000,
                          0x80000000}},  // -10
     .expected_return_code = 0,
     .test_name = "(-15) - (-5) = -10"})

SUB_TEST_CASES(
    sub_different_scales_simple,
    {.value1 = {{0x0000002A, 0x00000000, 0x00000000,
                 0x00010000}},  // 4.2 (scale 1, мантисса 42)
     .value2 = {{0x00000002, 0x00000000, 0x00000000,
                 0x00000000}},  // 2.0 (scale 0, мантисса 2)
     .expected_result = {{0x00000016, 0x00000000, 0x00000000,
                          0x00010000}},  // 2.2 (scale 1, мантисса 22)
     .expected_return_code = 0,
     .test_name = "4.2 - 2 = 2.2"})
...
SUB_TEST_CASES(sub_zero_result_preserves_scale,
               {.value1 = {{0x00000005, 0x00000000, 0x00000000,
                ...
                .expected_result = {{0x00000000, 0x00000000, 0x00000000,
                                     0x00020000}},  // 0.00 (scale 2)
                .expected_return_code = 0,
                .test_name = "0.05 - 0.05 = 0.00"})

SUB_TEST_CASES(
    sub_bankers_rounding_down,
    {.value1 = {{0x0000000F, 0x00000000, 0x00000000, 0x00000000}},  // 15
     .value2 = {{0x0000000E, 0x00000000, 0x00000000,
                 0x001C0000}},  // 0.0000000000000000000000000014 (scale 28)
     .expected_result = {{0x0000000F, 0x00000000, 0x00000000,
                          0x00000000}},  // 15 (усекается без округления вверх)
     .expected_return_code = 0,
     .test_name = "15 - 1.4e-26 = 15"})

SUB_TEST_CASES(
    sub_bankers_rounding_to_even,
    {// value1 = MAX_DECIMAL (scale 0) — его невозможно умножить на 10!
     .value1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000}},
     // value2 = 1.5 (мантисса 15, scale 1) — ему придется уменьшать масштаб до
     // 0
     ...
     .expected_return_code = 0,
     .test_name = "MAX_DECIMAL - 1.5 (1.5 округляется до 2 из-за невозможности "
                  "выровнять scale)"})

SUB_TEST_CASES(
    sub_overflow_to_negative_infinity,
...
SUB_TEST_CASES(
    ...
    {.value1 = {{0x00000005, 0x00000000, 0x00000000, 0x00000000}},  // 5
     ...
     .expected_result = {{0x00000011, 0x00000000, 0x00000000,
                          0x00000000}},  // 17
     .expected_return_code = 0,
     .test_name = "5 - (-12) = 17"})
...
SUB_TEST_CASES(sub_minus_zero_and_scale,
               {.value1 = {{0x00000005, 0x00000000, 0x00000000,
                            0x80020000}},  // -0.05 (scale 2)
                .value2 = {{0x00000000, 0x00000000, 0x00000000,
                            0x00000000}},  // 0 (scale 0)
...
SUB_TEST_CASES(
    sub_from_zero_negative,
    {.value1 = {{0x00000000, 0x00000000, 0x00000000,
                 0x00000000}},  // 0 (scale 0)
     .value2 = {{0x00000037, 0x00000000, 0x00000000,
                 0x80010000}},  // -5.5 (scale 1, мантисса 55)
     .expected_result = {{0x00000037, 0x00000000, 0x00000000,
                          0x00010000}},  // 5.5 (scale 1, мантисса 55)
     .expected_return_code = 0,
     .test_name = "0 - (-5.5) = 5.5"})

SUB_TEST_CASES(sub_max_scale_difference,
               {.value1 = {{0x0000000A, 0x00000000, 0x00000000,
                            0x00000000}},  // 10 (scale 0)
                .value2 = {{0x00000002, 0x00000000, 0x00000000,
                            0x001C0000}},  // 2e-28 (scale 28)
                .expected_result =
                    {{0x0000000A, 0x00000000, 0x00000000,
                      0x00000000}},  // 10 (scale 0, усечение без округления)
                .expected_return_code = 0,
                .test_name = "10 - 2e-28 = 10"})

SUB_TEST_CASES(sub_extreme_small_zero,
               {.value1 = {{0x00000002, 0x00000000, 0x00000000,
                            0x001C0000}},  // 2e-28 (scale 28)
                .value2 = {{0x00000002, 0x00000000, 0x00000000,
                            0x001C0000}},  // 2e-28 (scale 28)
                .expected_result =
                    {{0x00000000, 0x00000000, 0x00000000,
                      0x001C0000}},  // 0e-28 (scale 28, сохранение экспоненты)
                .expected_return_code = 0,
                .test_name = "2e-28 - 2e-28 = 0e-28"})

SUB_TEST_CASES(
    sub_overflow_minus_max,
    {.value1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
                 0x80000000}},  // -MAX_DECIMAL
     .value2 = {{0x00000001, 0x00000000, 0x00000000, 0x00000000}},  // +1
     .expected_result = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}},
