...
EXTRA_NEGATE_TEST_CASES(negate_max_positive, {
    .value1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000}}, // MAX_INT
    .expected_result = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x80000000}}, // -MAX_INT
    .expected_return_code = 0,
    .test_name = "negate: MAX_INT -> -MAX_INT"
})

EXTRA_NEGATE_TEST_CASES(negate_min_negative, {
    .value1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x80000000}}, // -MAX_INT
    .expected_result = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000}}, // MAX_INT
    .expected_return_code = 0,
    .test_name = "negate: -MAX_INT -> MAX_INT"
})

EXTRA_NEGATE_TEST_CASES(negate_large_with_scale, {
    .value1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x00010000}}, // MAX_INT/10
    .expected_result = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x80010000}}, // -MAX_INT/10
    .expected_return_code = 0,
    .test_name = "negate: large number with scale"
})

EXTRA_NEGATE_TEST_CASES(negate_max_scale, {
    .value1 = {{0x00000001, 0x00000000, 0x00000000, 0x001C0000}}, // 1e-28 (scale=28)
    .expected_result = {{0x00000001, 0x00000000, 0x00000000, 0x801C0000}}, // -1e-28
    .expected_return_code = 0,
    .test_name = "negate: max scale (28) -> negative"
})

EXTRA_NEGATE_TEST_CASES(negate_all_bits_set, {
    .value1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000}}, // все биты
    .expected_result = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x80000000}}, // все биты со знаком
    .expected_return_code = 0,
...
EXTRA_TRUNCATE_TEST_CASES(truncate_whole_large, {
    .value1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000}}, // MAX_INT
    .expected_result = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000}}, // MAX_INT
    .expected_return_code = 0,
...
EXTRA_TRUNCATE_TEST_CASES(truncate_whole_large_negative, {
    .value1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x80000000}}, // -MAX_INT
    .expected_result = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x80000000}}, // -MAX_INT
    .expected_return_code = 0,
    .test_name = "truncate: -MAX_INT -> -MAX_INT"
...
EXTRA_TRUNCATE_TEST_CASES(truncate_fractional_positive, {
    .value1 = {{0x00003039, 0x00000000, 0x00000000, 0x00020000}}, // 123.45
    .expected_result = {{0x0000007B, 0x00000000, 0x00000000, 0x00000000}}, // 123
    .expected_return_code = 0,
    .test_name = "truncate: 123.45 -> 123"
})

EXTRA_TRUNCATE_TEST_CASES(truncate_fractional_negative, {
    .value1 = {{0x00003039, 0x00000000, 0x00000000, 0x80020000}}, // -123.45
    .expected_result = {{0x0000007B, 0x00000000, 0x00000000, 0x80000000}}, // -123
    .expected_return_code = 0,
    .test_name = "truncate: -123.45 -> -123"
})

EXTRA_TRUNCATE_TEST_CASES(truncate_fractional_small, {
    .value1 = {{0x0000000A, 0x00000000, 0x00000000, 0x00010000}}, // 1.0 (scale=1)
...
EXTRA_TRUNCATE_TEST_CASES(truncate_fractional_less_than_one, {
    .value1 = {{0x00000009, 0x00000000, 0x00000000, 0x00010000}}, // 0.9 (scale=1)
    .expected_result = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}}, // 0
    .expected_return_code = 0,
...
EXTRA_TRUNCATE_TEST_CASES(truncate_fractional_negative_less_than_one, {
    .value1 = {{0x00000005, 0x00000000, 0x00000000, 0x80010000}}, // -0.5 (scale=1)
    .expected_result = {{0x00000000, 0x00000000, 0x00000000, 0x80000000}}, // -0
    .expected_return_code = 0,
    .test_name = "truncate: -0.5 -> -0"
})

EXTRA_TRUNCATE_TEST_CASES(truncate_fractional_scale_3, {
    .value1 = {{0x0001E240, 0x00000000, 0x00000000, 0x00030000}}, // 123.456 (scale=3)
    .expected_result = {{0x0000007B, 0x00000000, 0x00000000, 0x00000000}}, // 123
    .expected_return_code = 0,
...
EXTRA_TRUNCATE_TEST_CASES(truncate_fractional_scale_4, {
    .value1 = {{0x00000001, 0x00000000, 0x00000000, 0x00040000}}, // 0.0001 (scale=4)
    .expected_result = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}}, // 0
    .expected_return_code = 0,
    .test_name = "truncate: 0.0001 -> 0"
})

EXTRA_TRUNCATE_TEST_CASES(truncate_fractional_scale_28, {
    .value1 = {{0x00000001, 0x00000000, 0x00000000, 0x001C0000}}, // min value (scale=28)
    .expected_result = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}}, // 0
    .expected_return_code = 0,
...
EXTRA_TRUNCATE_TEST_CASES(truncate_with_scale_1, {
    .value1 = {{0x0000000F, 0x00000000, 0x00000000, 0x00010000}}, // 1.5 (scale=1)
    .expected_result = {{0x00000001, 0x00000000, 0x00000000, 0x00000000}}, // 1
    .expected_return_code = 0,
...
EXTRA_TRUNCATE_TEST_CASES(truncate_with_scale_1_negative, {
    ...
    .expected_result = {{0x00000001, 0x00000000, 0x00000000, 0x80000000}}, // -1
    .expected_return_code = 0,
    .test_name = "truncate: -1.5 -> -1"
})

EXTRA_TRUNCATE_TEST_CASES(truncate_with_scale_2, {
    .value1 = {{0x000000C8, 0x00000000, 0x00000000, 0x00020000}}, // 2.00 (scale=2)
    .expected_result = {{0x00000002, 0x00000000, 0x00000000, 0x00000000}}, // 2
    .expected_return_code = 0,
...
EXTRA_TRUNCATE_TEST_CASES(truncate_with_scale_2_negative, {
    .value1 = {{0x000000C8, 0x00000000, 0x00000000, 0x80020000}}, // -2.00
    .expected_result = {{0x00000002, 0x00000000, 0x00000000, 0x80000000}}, // -2
    .expected_return_code = 0,
    .test_name = "truncate: -2.00 -> -2"
})
...
EXTRA_TRUNCATE_TEST_CASES(truncate_large_fractional, {
    .value1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x00010000}}, // MAX_INT / 10
    .expected_result = {{0x99999999, 0x99999999, 0x19999999, 0x00000000}}, // целая часть
    .expected_return_code = 0,
    .test_name = "truncate: MAX_INT/10 -> целая часть"
})

EXTRA_TRUNCATE_TEST_CASES(truncate_large_fractional_negative, {
    .value1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x80010000}}, // -MAX_INT / 10
    .expected_result = {{0x99999999, 0x99999999, 0x19999999, 0x80000000}}, // -целая часть
    .expected_return_code = 0,
    .test_name = "truncate: -MAX_INT/10 -> -целая часть"
})
...
EXTRA_TRUNCATE_TEST_CASES(truncate_invalid_scale_255, {
    .value1 = {{0x00000005, 0x00000000, 0x00000000, 0x00FF0000}}, // scale=255 (invalid)
...
EXTRA_TRUNCATE_TEST_CASES(truncate_invalid_scale_29, {
    .value1 = {{0x00000005, 0x00000000, 0x00000000, 0x001D0000}}, // scale=29 (invalid)
    .expected_result = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}},
    .expected_return_code = 1,
...
EXTRA_TRUNCATE_TEST_CASES(truncate_very_small_negative, {
    .value1 = {{0x00000001, 0x00000000, 0x00000000, 0x801C0000}}, // -1e-28
    .expected_result = {{0x00000000, 0x00000000, 0x00000000, 0x80000000}}, // -0
    .expected_return_code = 0,
    .test_name = "truncate: -1e-28 -> -0"
})
...
EXTRA_ROUND_TEST_CASES(round_0_5_to_0, {
    .value1 = {{0x00000005, 0x00000000, 0x00000000, 0x00010000}}, // 0.5
    .expected_result = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}}, // 0 (четное)
    .expected_return_code = 0,
...
EXTRA_ROUND_TEST_CASES(round_1_5_to_2, {
    ...
    .expected_result = {{0x00000002, 0x00000000, 0x00000000, 0x00000000}}, // 2 (четное)
    .expected_return_code = 0,
    .test_name = "round: 1.5 -> 2 (banking)"
})

EXTRA_ROUND_TEST_CASES(round_2_5_to_2, {
    .value1 = {{0x00000019, 0x00000000, 0x00000000, 0x00010000}}, // 2.5
    .expected_result = {{0x00000002, 0x00000000, 0x00000000, 0x00000000}}, // 2 (четное)
    .expected_return_code = 0,
...
EXTRA_ROUND_TEST_CASES(round_3_5_to_4, {
    .value1 = {{0x00000023, 0x00000000, 0x00000000, 0x00010000}}, // 3.5
    .expected_result = {{0x00000004, 0x00000000, 0x00000000, 0x00000000}}, // 4 (четное)
    .expected_return_code = 0,
    .test_name = "round: 3.5 -> 4 (banking)"
})

EXTRA_ROUND_TEST_CASES(round_4_5_to_4, {
    .value1 = {{0x0000002D, 0x00000000, 0x00000000, 0x00010000}}, // 4.5
    .expected_result = {{0x00000004, 0x00000000, 0x00000000, 0x00000000}}, // 4 (четное)
    .expected_return_code = 0,
...
EXTRA_ROUND_TEST_CASES(round_negative_0_5_to_0, {
    .value1 = {{0x00000005, 0x00000000, 0x00000000, 0x80010000}}, // -0.5
    .expected_result = {{0x00000000, 0x00000000, 0x00000000, 0x80000000}}, // -0
    .expected_return_code = 0,
    .test_name = "round: -0.5 -> -0 (banking)"
})
...
EXTRA_ROUND_TEST_CASES(round_negative_1_5_to_2, {
    .value1 = {{0x0000000F, 0x00000000, 0x00000000, 0x80010000}}, // -1.5
    .expected_result = {{0x00000002, 0x00000000, 0x00000000, 0x80000000}}, // -2 (четное)
    .expected_return_code = 0,
    .test_name = "round: -1.5 -> -2 (banking)"
})

EXTRA_ROUND_TEST_CASES(round_negative_2_5_to_2, {
    .value1 = {{0x00000019, 0x00000000, 0x00000000, 0x80010000}}, // -2.5
    .expected_result = {{0x00000002, 0x00000000, 0x00000000, 0x80000000}}, // -2 (четное)
    .expected_return_code = 0,
    .test_name = "round: -2.5 -> -2 (banking)"
})
...
EXTRA_ROUND_TEST_CASES(round_negative_3_5_to_4, {
    .value1 = {{0x00000023, 0x00000000, 0x00000000, 0x80010000}}, // -3.5
    .expected_result = {{0x00000004, 0x00000000, 0x00000000, 0x80000000}}, // -4 (четное)
    .expected_return_code = 0,
    .test_name = "round: -3.5 -> -4 (banking)"
})

EXTRA_ROUND_TEST_CASES(round_0_4_to_0, {
    .value1 = {{0x00000004, 0x00000000, 0x00000000, 0x00010000}}, // 0.4
    .expected_result = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}}, // 0
    .expected_return_code = 0,
...
EXTRA_ROUND_TEST_CASES(round_0_6_to_1, {
    .value1 = {{0x00000006, 0x00000000, 0x00000000, 0x00010000}}, // 0.6
    .expected_result = {{0x00000001, 0x00000000, 0x00000000, 0x00000000}}, // 1
    .expected_return_code = 0,
...
EXTRA_ROUND_TEST_CASES(round_negative_0_4_to_0, {
    .value1 = {{0x00000004, 0x00000000, 0x00000000, 0x80010000}}, // -0.4
    .expected_result = {{0x00000000, 0x00000000, 0x00000000, 0x80000000}}, // -0
    .expected_return_code = 0,
    .test_name = "round: -0.4 -> -0"
})
...
EXTRA_ROUND_TEST_CASES(round_negative_0_6_to_1, {
    .value1 = {{0x00000006, 0x00000000, 0x00000000, 0x80010000}}, // -0.6
    .expected_result = {{0x00000001, 0x00000000, 0x00000000, 0x80000000}}, // -1
    .expected_return_code = 0,
    .test_name = "round: -0.6 -> -1"
})
...
EXTRA_ROUND_TEST_CASES(round_scale_2_123_55, {
    .value1 = {{0x00003043, 0x00000000, 0x00000000, 0x00020000}}, // 123.55
    .expected_result = {{0x0000007C, 0x00000000, 0x00000000, 0x00000000}}, // 124
    .expected_return_code = 0,
    .test_name = "round: 123.55 -> 124"
})

EXTRA_ROUND_TEST_CASES(round_scale_2_123_50, {
    .value1 = {{0x0000303E, 0x00000000, 0x00000000, 0x00020000}}, // 123.50
    .expected_result = {{0x0000007C, 0x00000000, 0x00000000, 0x00000000}}, // 124 (т.к. 123 нечетное)
    .expected_return_code = 0,
    .test_name = "round: 123.50 -> 124 (banking)"
})

EXTRA_ROUND_TEST_CASES(round_scale_2_122_50, {
    .value1 = {{0x00002FDA, 0x00000000, 0x00000000, 0x00020000}}, // 122.50
    .expected_result = {{0x0000007A, 0x00000000, 0x00000000, 0x00000000}}, // 122 (т.к. 122 четное)
    .expected_return_code = 0,
    .test_name = "round: 122.50 -> 122 (banking)"
})

EXTRA_ROUND_TEST_CASES(round_scale_3_123_456, {
    .value1 = {{0x0001E240, 0x00000000, 0x00000000, 0x00030000}}, // 123.456
    .expected_result = {{0x0000007B, 0x00000000, 0x00000000, 0x00000000}}, // 123
    .expected_return_code = 0,
...
EXTRA_ROUND_TEST_CASES(round_scale_3_123_556, {
    .value1 = {{0x0001E28C, 0x00000000, 0x00000000, 0x00030000}}, // 123.556
    .expected_result = {{0x0000007C, 0x00000000, 0x00000000, 0x00000000}}, // 124
    .expected_return_code = 0,
...
EXTRA_ROUND_TEST_CASES(round_scale_4_0_0005, {
    .value1 = {{0x00000005, 0x00000000, 0x00000000, 0x00040000}}, // 0.0005
    .expected_result = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}}, // 0
    .expected_return_code = 0,
    .test_name = "round: 0.0005 -> 0"
})

EXTRA_ROUND_TEST_CASES(round_scale_4_0_0006, {
    .value1 = {{0x00000006, 0x00000000, 0x00000000, 0x00040000}}, // 0.0006
    .expected_result = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}}, // 0 (т.к. первая цифра 0)
    .expected_return_code = 0,
...
EXTRA_ROUND_TEST_CASES(round_max_int_with_scale_1, {
    .value1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x00010000}}, // MAX_INT / 10
    .expected_result = {{0x9999999A, 0x99999999, 0x19999999, 0x00000000}}, // целая часть
    .expected_return_code = 0,
...
EXTRA_ROUND_TEST_CASES(round_invalid_scale_255, {
...
EXTRA_ROUND_TEST_CASES(round_invalid_scale_29, {
...
EXTRA_ROUND_TEST_CASES(round_sign_preservation_negative, {
    .value1 = {{0x0000000A, 0x00000000, 0x00000000, 0x80010000}}, // -1.0
    .expected_result = {{0x00000001, 0x00000000, 0x00000000, 0x80000000}}, // -1
    .expected_return_code = 0,
    .test_name = "round: negative sign preserved"
})

EXTRA_ROUND_TEST_CASES(round_123_4567, {
    .value1 = {{0x0012D687, 0x00000000, 0x00000000, 0x00040000}}, // 123.4567 (scale=4)
    .expected_result = {{0x0000007B, 0x00000000, 0x00000000, 0x00000000}}, // 123 (первая цифра 4)
    .expected_return_code = 0,
    .test_name = "round: 123.4567 -> 123"
})

EXTRA_ROUND_TEST_CASES(round_123_5567, {
    .value1 = {{0x0012DABF, 0x00000000, 0x00000000, 0x00040000}}, // 123.5567 (scale=4)
    .expected_result = {{0x0000007C, 0x00000000, 0x00000000, 0x00000000}}, // 124
    .expected_return_code = 0,
...
EXTRA_ROUND_TEST_CASES(round_negative_123_4567, {
    .value1 = {{0x0012D687, 0x00000000, 0x00000000, 0x80040000}}, // -123.4567
    .expected_result = {{0x0000007B, 0x00000000, 0x00000000, 0x80000000}}, // -123
    .expected_return_code = 0,
    .test_name = "round: -123.4567 -> -123"
})
...
EXTRA_ROUND_TEST_CASES(round_negative_123_5567, {
    .value1 = {{0x0012DABF, 0x00000000, 0x00000000, 0x80040000}}, // -123.5567
    .expected_result = {{0x0000007C, 0x00000000, 0x00000000, 0x80000000}}, // -124
    .expected_return_code = 0,
    .test_name = "round: -123.5567 -> -124"
})
...
EXTRA_FLOOR_TEST_CASES(floor_positive_0_9, {
    .value1 = {{0x00000009, 0x00000000, 0x00000000, 0x00010000}}, // 0.9
    .expected_result = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}}, // 0
    .expected_return_code = 0,
...
EXTRA_FLOOR_TEST_CASES(floor_positive_1_1, {
    .value1 = {{0x0000000B, 0x00000000, 0x00000000, 0x00010000}}, // 1.1
    .expected_result = {{0x00000001, 0x00000000, 0x00000000, 0x00000000}}, // 1
    .expected_return_code = 0,
...
EXTRA_FLOOR_TEST_CASES(floor_positive_1_9, {
    .value1 = {{0x00000013, 0x00000000, 0x00000000, 0x00010000}}, // 1.9
    .expected_result = {{0x00000001, 0x00000000, 0x00000000, 0x00000000}}, // 1
    .expected_return_code = 0,
...
EXTRA_FLOOR_TEST_CASES(floor_positive_123_99, {
    .value1 = {{0x0000306F, 0x00000000, 0x00000000, 0x00020000}}, // 123.99
    .expected_result = {{0x0000007B, 0x00000000, 0x00000000, 0x00000000}}, // 123
    .expected_return_code = 0,
...
EXTRA_FLOOR_TEST_CASES(floor_negative_0_1, {
    .value1 = {{0x00000001, 0x00000000, 0x00000000, 0x80010000}}, // -0.1
    .expected_result = {{0x00000001, 0x00000000, 0x00000000, 0x80000000}}, // -1
    .expected_return_code = 0,
...
EXTRA_FLOOR_TEST_CASES(floor_negative_0_9, {
    .value1 = {{0x00000009, 0x00000000, 0x00000000, 0x80010000}}, // -0.9
    .expected_result = {{0x00000001, 0x00000000, 0x00000000, 0x80000000}}, // -1
    .expected_return_code = 0,
...
EXTRA_FLOOR_TEST_CASES(floor_negative_1_1, {
    .value1 = {{0x0000000B, 0x00000000, 0x00000000, 0x80010000}}, // -1.1
    .expected_result = {{0x00000002, 0x00000000, 0x00000000, 0x80000000}}, // -2
    .expected_return_code = 0,
...
EXTRA_FLOOR_TEST_CASES(floor_negative_1_9, {
    .value1 = {{0x00000013, 0x00000000, 0x00000000, 0x80010000}}, // -1.9
    .expected_result = {{0x00000002, 0x00000000, 0x00000000, 0x80000000}}, // -2
    .expected_return_code = 0,
...
EXTRA_FLOOR_TEST_CASES(floor_negative_123_01, {
    .value1 = {{0x0000300D, 0x00000000, 0x00000000, 0x80020000}}, // -123.01
    .expected_result = {{0x0000007C, 0x00000000, 0x00000000, 0x80000000}}, // -124
    .expected_return_code = 0,
...
EXTRA_FLOOR_TEST_CASES(floor_negative_123_99, {
    .value1 = {{0x0000306F, 0x00000000, 0x00000000, 0x80020000}}, // -123.99
    .expected_result = {{0x0000007C, 0x00000000, 0x00000000, 0x80000000}}, // -124
    .expected_return_code = 0,
...
EXTRA_FLOOR_TEST_CASES(floor_scale_4_123_4567, {
    .value1 = {{0x0012D687, 0x00000000, 0x00000000, 0x00040000}}, // 123.4567
    .expected_result = {{0x0000007B, 0x00000000, 0x00000000, 0x00000000}}, // 123
    .expected_return_code = 0,
...
EXTRA_FLOOR_TEST_CASES(floor_scale_5_0_00005, {
    .value1 = {{0x00000005, 0x00000000, 0x00000000, 0x00050000}}, // 0.00005
    .expected_result = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}}, // 0
    .expected_return_code = 0,
...
EXTRA_FLOOR_TEST_CASES(floor_scale_3_negative_123_456, {
    .value1 = {{0x0001E240, 0x00000000, 0x00000000, 0x80030000}}, // -123.456
    .expected_result = {{0x0000007C, 0x00000000, 0x00000000, 0x80000000}}, // -124
    .expected_return_code = 0,
...
EXTRA_FLOOR_TEST_CASES(floor_scale_5_negative_0_00005, {
    .value1 = {{0x00000005, 0x00000000, 0x00000000, 0x80050000}}, // -0.00005
    .expected_result = {{0x00000001, 0x00000000, 0x00000000, 0x80000000}}, // -1
    .expected_return_code = 0,
...
EXTRA_FLOOR_TEST_CASES(floor_max_int_negative_with_scale_1, {
    .value1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x80010000}}, // -MAX_INT / 10
    .expected_result = {{0x9999999A, 0x99999999, 0x19999999, 0x80000000}}, // -целая часть
    .expected_return_code = 0,
    .test_name = "floor: -MAX_INT/10 -> -целая часть"
})
...
EXTRA_FLOOR_TEST_CASES(floor_max_scale_negative_5e28, {
    .value1 = {{0x00000005, 0x00000000, 0x00000000, 0x801C0000}}, // -5e-28
    .expected_result = {{0x00000001, 0x00000000, 0x00000000, 0x80000000}}, // -1
    .expected_return_code = 0,
...
EXTRA_FLOOR_TEST_CASES(floor_invalid_scale_255, {
    .value1 = {{0x00000005, 0x00000000, 0x00000000, 0x00FF0000}}, // scale=255
    .expected_result = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}},
    .expected_return_code = 1,
...
EXTRA_FLOOR_TEST_CASES(floor_invalid_scale_29, {
    .value1 = {{0x00000005, 0x00000000, 0x00000000, 0x001D0000}}, // scale=29
    .expected_result = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}},
    .expected_return_code = 1,
...
EXTRA_FLOOR_TEST_CASES(floor_negative_123_000, {
    .value1 = {{0x0000300C, 0x00000000, 0x00000000, 0x80020000}}, // -123.00
    .expected_result = {{0x0000007B, 0x00000000, 0x00000000, 0x80000000}}, // -123
    .expected_return_code = 0,
...
EXTRA_FLOOR_TEST_CASES(floor_negative_123_001, {
    .value1 = {{0x0001E079, 0x00000000, 0x00000000, 0x80030000}}, // -123.001
    .expected_result = {{0x0000007C, 0x00000000, 0x00000000, 0x80000000}}, // -124
    .expected_return_code = 0,
...
EXTRA_FLOOR_TEST_CASES(floor_negative_0_000, {
    .value1 = {{0x00000000, 0x00000000, 0x00000000, 0x80030000}}, // -0.000
    .expected_result = {{0x00000000, 0x00000000, 0x00000000, 0x80000000}}, // -0
    .expected_return_code = 0,
