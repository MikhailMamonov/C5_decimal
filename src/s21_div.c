...
void division_cycle(big_decimal dividend, big_decimal divider,
                    big_decimal *remainder, big_decimal *result, int last_bit);
...
int s21_div(s21_decimal value_1, s21_decimal value_2, s21_decimal *result) {
  ...
  int res_scale = get_scale(value_1.bits[SIGNIFICANT_BYTES]) -
                  get_scale(value_2.bits[SIGNIFICANT_BYTES]);
